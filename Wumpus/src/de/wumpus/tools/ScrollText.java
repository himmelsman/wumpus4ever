...
public class ScrollText extends JPanel implements Runnable {
	...
	public void run () {
		Vector<String> credits = new Vector<String>();
		{
			...
			String[] line = new String[]{"Special Thanks To:", "","Andreas Holste", "", "Für kreative Ideen am Rande des Wahnsinns.", "","Alex Maier", "", "Für die Optimisierung der Source-Code.", "","Julien Schmitt", "", "Für Test/Feedback des Programms und krasse Ablenkung.", "", "Max und Moritz", "", "Für das erwärmen meiner Füße an kalten Tagen."};
			while (i<line.length)
