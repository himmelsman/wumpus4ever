...
public class HelpScreen extends JFrame {
	...
	private String helpText = 
		"Die Wumpus-Welt\n"+
"Ein Agent erforscht eine Höhle auf der Suche nach einem Goldschatz. Die" +
"Höhle besteht aus mehreren miteinander verbundenen Räumen. Irgendwo in" +
"der Höhle lauert der Wumpus, ein Ungeheuer, das jeden frisst, der in seine" +
"Nähe kommt. Obendrein gibt es Fallgruben (PITs), in die der Agent stürzen" +
"kann. Die Höhle besteht aus 4x4 Feldern (Räumen). Auf dem Feld, auf dem" +
"sich der Wumpus befindet, und in den unmittelbar benachbarten Feldern" +
"nimmt man einen unangenehmen Geruch wahr (Stench). Auf Feldern, die" +
"unmittelbar neben einer Fallgrube liegen, spürt man einen Luftzug (Breeze).\n\n" +
"Ziel\n" +
